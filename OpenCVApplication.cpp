...
void cameraCalibration()
{
	...
	while (fg.getNextAbsFile(fname))
	{
		...
		bool found = findChessboardCorners(src, boardSize, pointBuf, CALIB_CB_ADAPTIVE_THRESH | CALIB_CB_NORMALIZE_IMAGE | CALIB_CB_FAST_CHECK);

		if(found)
		{
			cornerSubPix(src, pointBuf, Size(11, 11), Size(-1, -1), criteria);
